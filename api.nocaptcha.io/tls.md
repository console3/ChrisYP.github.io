...
| 参数名          | 类型        | 说明                                                                                                                                                             | 必须  |
|--------------|-----------|----------------------------------------------------------------------------------------------------------------------------------------------------------------|-----|
| `requests`                  | `Array`   | `支持多请求(最多 3 个), 异步并发请求, 等待所有请求完成时返回`                                                                                               | `是` |
...
| `requests[0].timeout`       | `Number`   | `请求超时时间（秒）, 默认 15 秒`   | `否` |
| `requests[0].http2`         | `Boolean`  | `是否 http2 协议, 默认 false`   | `否` |
| `requests[0].redirect`      | `Boolean`  | `是否重定向, 默认 true`   | `否` |
| `requests[0].ja3`           | `String`   | `自定义 ja3 指纹, 不传表现为最新 chrome 的随机指纹`   | `否` |
        ...
        "responses": [
            {
                ...
                "cookies": {
                    "dtCookie": 'v_4_srv_6_sn_784933A1C256E2FA0FADD1DBAB8A2037_perc_100000_ol_0_mul_1_app-3Aea7c4b59f27d43eb_1',
                    "_abck": 'F395AEBC02984E0F8DEC0B5ADC03BF40~0~~-1~-1~-1',
                    "ak_bmsc": '46079984D717CCBA530360FC91EA72C1~000000000000000000000000000000~',
                    "bm_sz": '047A4B4758AC91FC46F2A771ECCB41D0~~3229251~3425601'
                }
            }
        ]
    }
